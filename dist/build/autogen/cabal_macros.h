...
/* package Mugi-0.1.0.0 */
#define VERSION_Mugi "0.1.0.0"
#define MIN_VERSION_Mugi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package process-1.6.2.0 */
#define VERSION_process "1.6.2.0"
...
#define CURRENT_COMPONENT_ID "Mugi-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Mugi-0.1.0.0"
